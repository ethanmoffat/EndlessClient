namespace EOLib.Localization
{
    ...
    public enum EOResourceID
    {
        ...
        GUILD_A_GUILD_RECRUITER_MUST_BE_PRESENT = 206,
        GUILD_PLEASE_CONSIDER_WHAT_GUILD_YOU_ARE_JOINING = 207,
        GUILD_CLICK_HERE_TO_JOIN_A_GUILD = 208,
        GUILD_YOU_ARE_ABOUT_TO_LEAVE_THE_GUILD = 209,
        GUILD_AFTER_YOU_HAVE_LEFT = 210,
        GUILD_CLICK_HERE_TO_LEAVE_YOUR_GUILD = 211,
        GUILD_GUILD_INFO = 212,
        GUILD_MIN_MEMBERS_INFO = 213,
        GUILD_MASTER_FEE_INFO = 214,
        GUILD_REGISTER_GUILD_PROMPT = 215,
        GUILD_ENTER_GUILD_DETAILS = 216,
        GUILD_TAG_LABEL = 217,
        GUILD_NAME_LABEL = 218,
        GUILD_DESCRIPTION = 219,
        GUILD_RANKING_LABEL = 220,
        GUILD_MANAGEMENT_INFO = 221,
        GUILD_ACCEPT_PROMPT = 223,
        GUILD_RECRUITER_LABEL = 224,
        GUILD_ACCOUNT_CHARGE_INFO = 225,
        GUILD_RECRUITER_WARNING = 226,
        GUILD_VIEW_INFO_PROMPT = 227,
        GUILD_SIGNUP_DATE_LABEL = 228,
        GUILD_DESCRIPTION_LABEL = 229,
        GUILD_DESCRIPTION_LABEL_DUPLICATE = 229,
        GUILD_RANKING_SYSTEM_LABEL = 230,
        GUILD_LEADER_LABEL = 231,
        GUILD_RECRUITER_WITH_S_LABEL = 232,
        GUILD_ASSIGN_RANK_LABEL = 233,
        GUILD_CURRENT_DESCRIPTION_LABEL = 234,
        GUILD_CHANGE_DESCRIPTION_PROMPT = 235,
        GUILD_ENTER_RANKINGS_PROMPT = 236,
        GUILD_DISBAND_INFO = 237,
        GUILD_DISBAND_WARNING = 238,
        GUILD_DISBAND_PROMPT = 239,
        GUILD_REMOVE_MEMBER_INFO = 240,
        GUILD_REMOVE_MEMBER_WARNING = 241,
        GUILD_REMOVE_MEMBER_PROMPT = 242,
        GUILD_REMOVE_MEMBER_QUESTION = 243,
        GUILD_BANK_STATUS_LABEL = 244,
        GUILD_BANK_DEPOSIT_ONLY_INFO = 245,
        GUILD_BANK_USAGE_INFO = 246,
        GUILD_DEPOSIT_PROMPT = 247,
        GUILD_ASSIGN_RANK_INFO = 248,
        GUILD_RANKINGS_INFO = 249,
        GUILD_ASSIGN_RANK_PROMPT = 250,
        GUILD_NAME_PLAYER_LABEL = 251,
        GUILD_RANK_LABEL = 252,
        ...
        GUILD_LOOK_UP = 267,
        VIEW_GUILD_DETAILS = 268,
        MEMBERLIST = 269,
        VIEW_GUILD_MEMBERS = 270,
