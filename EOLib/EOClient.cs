...
namespace EndlessClient
{
	...
	public class EOClient : AsyncClient
	{
		...
		public delegate void DataTransferEvent(DataTransferEventArgs e);

		public event DataTransferEvent EventSendData;
		public event DataTransferEvent EventReceiveData;
		public event Action EventDisconnect;

		/// <summary>
		/// Set to 'true' when a file is requested. Changes handling for received data
		/// </summary>
		public bool ExpectingFile { get; set; }
		/// <summary>
		/// Set to 'true' when online player list is requested. Changes handling for received data
		/// </summary>
		public bool ExpectingPlayerList { get; set; }
		...
		public void SetInitData(EOLib.Net.InitData data)
		{
