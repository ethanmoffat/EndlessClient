...
//			if (client.ExpectingPlayerList && !response.WaitOne(Constants.ResponseTimeout))
//				return false;
...
//			if (client.ExpectingFile && !response.WaitOne(Constants.ResponseFileTimeout))
//				return;

//			response.Reset();

//			client.ExpectingPlayerList = true;
...
//					if (client.ExpectingFile)
//					{
//						client.ExpectingFile = false;
...
//				{
//					short requestedMap;
//					if (!client.ExpectingFile && Warp.RequestedMap > 0) //condition under which a file was requested for a warp.
...
//			client.ExpectingFile = false;
//			client.ExpectingPlayerList = false;
//			response.Set();
//		}
