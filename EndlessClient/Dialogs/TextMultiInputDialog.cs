...
namespace EndlessClient.Dialogs
{
    public class TextMultiInputDialog : BaseEODialog
    {
        ...
        // OnUpdateControl needs to solely run if Dialog.Nine is in use
        ...
        protected override void OnUpdateControl(GameTime gameTime)
        {
            ...
            if (_inputBoxes.Length > _scrollBar.LinesToRender)
            {
            ...
            else if (_inputBoxes.Any(_item => _item.Visible) || _inputLabels.Any(_item => !_item.Visible))
            {
                foreach (var item in _inputBoxes)
                {
                    item.Visible = true;
                }
                foreach (var item in _inputLabels)
                {
                    item.Visible = true;
                }
            }
